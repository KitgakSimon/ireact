        ...
        <AnimatePresence mode="wait">
          ...
          >
            <Image 
              ...
              alt="Hero Background" 
              fill 
              className="object-cover brightness-[0.7] transform scale-105 transition-transform duration-10000 ease-linear"
              priority={currentIndex === 0}
            />
          </motion.div>
        </AnimatePresence>
        <div className="absolute inset-0 bg-linear-to-b from-brand-dark/60 via-brand-dark/30 to-slate-900/80 pointer-events-none z-10"></div>
        <div className="absolute inset-0 square-grid opacity-20 pointer-events-none z-10"></div>
      </div>
