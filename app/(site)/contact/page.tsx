...
const contactMethods = [
  ...
  },
  {
    ...
    value: "+234 (0) 905 659 6944",
    href: "tel:+2349056596944"
  },
  {
            ...
            >
              ...
              <div className="pt-12 border-t border-slate-200 space-y-8">
                ...
                <div className="flex gap-4">
                    <button className="flex-1 flex flex-col items-center justify-center gap-3 bg-white p-6 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:border-brand-teal transition-all group">
                    ...
                    <button className="flex-1 flex flex-col items-center justify-center gap-3 bg-white p-6 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:border-brand-forest transition-all group">
