...
import { Mail, Lock, LogIn, Github, Linkedin, AlertCircle } from "lucide-react";
      ...
      <div className="mx-auto w-full max-w-md px-6 py-12 relative z-10">
        ...
        >
          <form className="space-y-6">
            ...
            <button type="submit" className="w-full rounded-2xl bg-brand-forest px-8 py-4 text-lg font-bold text-white shadow-xl shadow-forest-500/10 transition-all hover:bg-brand-dark hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-3">
              Sign In
              <LogIn size={20} />
            </button>
          </form>
